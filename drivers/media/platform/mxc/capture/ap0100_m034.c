...
static DEVICE_ATTR(ap0100_m034_i2c_test, 0220, NULL, (void *)ap0100_m034_i2c_test);
...
static DEVICE_ATTR(ap0100_param, 0664, (void *)sensor_sysfs_read, (void *)sensor_sysfs_write);
...
static DEVICE_ATTR(tempmon_reset, 0220, NULL, ap0100_reset_tempmon_ctrl);
...
{
	if (fse->index >= ARRAY_SIZE(ap0100_m034_frame_data))
		return -EINVAL;
	fse->min_width = fse->max_width = ap0100_m034_frame_data[fse->index].width;
	fse->min_height = fse->max_height = ap0100_m034_frame_data[fse->index].height;
...
static struct v4l2_subdev_pad_ops ap0100_m034_subdev_pad_ops = {
	.enum_frame_size = ap0100_m034_enum_framesizes,
};

static struct v4l2_subdev_ops ap0100_m034_subdev_ops = {
	.video	= &ap0100_m034_subdev_video_ops,
	.pad    = &ap0100_m034_subdev_pad_ops,
};
