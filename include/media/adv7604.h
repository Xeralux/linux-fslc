...
enum adv7604_input_port {
	...
	ADV7604_INPUT_SOURCE,
        ADV7604_INPUT_MAX,
};
#define ADV7611_INPUT_SOURCE ADV7604_INPUT_HDMI_PORT_B
...
#define V4L2_CID_ADV_RX_HSYNC_START_SHIFT	(V4L2_CID_DV_CLASS_BASE + 0x1003)
#define V4L2_CID_ADV_RX_HSYNC_END_SHIFT	(V4L2_CID_DV_CLASS_BASE + 0x1004)
#define V4L2_CID_ADV_RX_VSYNC_START_SHIFT	(V4L2_CID_DV_CLASS_BASE + 0x1005)
#define V4L2_CID_ADV_RX_VSYNC_END_SHIFT	(V4L2_CID_DV_CLASS_BASE + 0x1006)
